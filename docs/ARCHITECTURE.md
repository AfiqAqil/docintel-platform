...
| **Long-running work** | One heartbeat extends both the SQS visibility timeout and the database lease, so the two never disagree about who owns the document |
